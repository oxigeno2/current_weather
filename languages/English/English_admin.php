 ...
 * @link https://github.com/oxigeno2/current_weather
 */
...
define("LAN_WEATHER_ADMIN_APPID_H", "In order to obtain an API key to register on <a href='http://openweathermap.org/' target='_blank'>openweathermap.org</a>");

define("LAN_WEATHER_HELP_1", "Where do I get the API (APPID)");
define("LAN_WEATHER_HELP_2", "To get the API key, register at <a href='http://openweathermap.org/' target='_blank'>openweathermap.org</a>. Then generate it on your user account page."); 
