...
define("LAN_WEATHER_ADMIN_APPID_H", "Pro získání API klíče se zaregistrujte na <a href='http://openweathermap.org/' target='_blank'>openweathermap.org</a>");

//help admin
define("LAN_WEATHER_HELP_1", "Kde získám API (APPID)");
define("LAN_WEATHER_HELP_2", "Pro získání API klíče se zaregistrujte na <a href='http://openweathermap.org/' target='_blank'>openweathermap.org</a>. Poté ho vygenerujte na stránce vašeho uživatelského účtu."); 
